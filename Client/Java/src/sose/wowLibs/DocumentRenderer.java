...
/*  
 * Thanks to Kei G. Gauthier for making this DocumentRenderer class.
 */
  ...
  protected void printDialog() {
    if (pJob.printDialog()) {
      ...
      try {
        ...
        javax.swing.JOptionPane.showMessageDialog(null, "An error occured while trying to print: " +
        		printerException.getMessage(), "Error", javax.swing.JOptionPane.ERROR_MESSAGE);
      }
    }
  }
