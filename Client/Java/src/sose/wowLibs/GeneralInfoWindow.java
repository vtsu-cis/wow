...
public class GeneralInfoWindow extends JFrame {
	...
	// protected static int numWindowsOpen = 0;
	 ...
	 public GeneralInfoWindow() {
		...
		this.setTitle("VTC General Information Page");
		...
		this.add(editorPane);
		this.setSize(775, 380);
		GUIBase.numGIWindowsOpen++;
	}
	...
	private JScrollPane createEditorPane() 
	{
	            ...
	            public void run() {
	              ...
	              try {
	                ...
	                JOptionPane.showMessageDialog (
	                  GeneralInfoWindow.this, "Can't follow link", 
	                  "Invalid Input", 
		...
		try 
		{
			helpURL = new java.net.URL("http://quicksilver.ecet.vtc.edu/WOW-BigBlueInfoIcon.html");
			if(helpURL != null)
			{
				Socket  s = new Socket();
				boolean flag = false;
		...
		catch (MalformedURLException e1) 
		{
            ...
            JOptionPane.showMessageDialog (
	                  GeneralInfoWindow.this, "Can't Open General Information Page", 
	                  "Invalid Web Address", 
	                   JOptionPane.ERROR_MESSAGE);
		}
	...
	public void getPageOffOfBrowser(NewEditorPane jt)
	{
		...
		try
		{
			...
			File config = new File(configPath + "/backupPage.htm");
