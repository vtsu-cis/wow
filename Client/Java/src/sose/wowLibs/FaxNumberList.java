...
/**
 * Shows a list of fax numbers and their respective departments, shown in fax-list.txt.
 * 
 * @author Andrew Sibley
 */
public class FaxNumberList extends JFrame {
	
	JScrollPane editorPane = null;
	 
	 public FaxNumberList() {
	...
	private JScrollPane createEditorPane() 
	{
	            ...
	            public void run() {
	              ...
	              try {
	                ...
	                JOptionPane.showMessageDialog (
	                  FaxNumberList.this, "Can't follow link", 
	                  "Invalid Input", 
		...
		try 
		{
			helpURL = new java.net.URL("http://wow.vtc.edu/faxNumbers.html");
			if(helpURL != null)
			{
				Socket  s = new Socket();
				boolean flag = false;
				...
				if(flag)
				{
					try {
						...
						File config = new File(configPath + "/backupFax.htm");
						if (!config.exists()) {
							JOptionPane.showMessageDialog (
					                  FaxNumberList.this,
					                  "The fax list cannot be opened right now.\n" +
					                  "Make sure you're using a VTC computer and try again.", 
					                  "Fax Page Cannot Be Displayed", 
					                   JOptionPane.ERROR_MESSAGE);
							return null;
						}
					}
		...
		catch (MalformedURLException e1) 
		{
            ...
            JOptionPane.showMessageDialog (
	                  FaxNumberList.this, "Can't open Fax Numbers page", 
	                  "Invalid Web Address", 
	                   JOptionPane.ERROR_MESSAGE);
		}
